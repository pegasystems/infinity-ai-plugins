---
name: testcase-business-action-assert-stage
description: Load when mapping a stage assertion business action. Shows AssertCaseStage with CaseID wiring and StageName constant.
---
