---
name: testcase-business-action-child-case-capture
description: Load when the app auto-creates a child case. Shows the child case business action capturing its case ID as output parameter with downstream child case business actions wiring CaseID from that output.
---
