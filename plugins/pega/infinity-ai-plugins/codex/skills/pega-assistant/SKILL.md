---
name: pega-assistant
description: Use when working with Pega Infinity through the bundled Pega Infinity Authoring Codex plugin. Start with the MCP server, load runtime skills first, confirm application context early, and use ChangeRequest-based authoring flows for write operations.
---

# Pega Assistant

Use this skill when the user is working on Pega Infinity rules, case types, application
configuration, or authoring workflows through the bundled Codex plugin.
