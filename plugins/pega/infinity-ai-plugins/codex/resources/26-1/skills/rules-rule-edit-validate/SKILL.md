...
`pyValidateName` is the class key and the identifier used to reference this rule from property definitions. When attaching a validate rule to a property, the property's edit validate field references the `pyValidateName`.
