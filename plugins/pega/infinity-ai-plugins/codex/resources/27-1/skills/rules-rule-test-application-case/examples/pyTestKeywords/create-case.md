---
name: testcase-business-action-create-case
description: Load when mapping a CreateCase business action. Shows case creation with CaseID output alias and input parameter wiring.
---
