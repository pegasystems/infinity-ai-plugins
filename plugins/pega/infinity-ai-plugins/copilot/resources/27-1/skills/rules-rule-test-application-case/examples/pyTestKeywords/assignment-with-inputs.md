---
name: testcase-business-action-assignment
description: Load when mapping an assignment business action with form inputs. Shows CaseID from business action Output and Business Action input parameters as Constants.
---
