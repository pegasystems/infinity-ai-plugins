---
name: testcase-business-action
description: Load when mapping a case-wide action business action. Shows PerformAction wiring with CaseID from prior business action output.
---
