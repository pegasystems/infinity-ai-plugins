...
description: Use this skill when the user asks to design or review a data model, choose between Case Type vs. Data Object, model a business process in Infinity Studio, add or change Case Types or Data Objects, or structure fields, relationships, primary fields, business keys, or attachments within a Pega application.
---
...
Creating Data Objects is not supported through the agent. This operation must be performed directly in the Data Designer in Infinity Studio.
...
- **Visual Data Model:** Use Infinity Studio's visual data modeler to audit relationships across Case Types and Data Objects before delivery.
