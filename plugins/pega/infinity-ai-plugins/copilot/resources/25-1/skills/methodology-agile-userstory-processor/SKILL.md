...
If the selected UserStory requires manual platform setup that cannot be executed through available MCP tools (for example, Email Account configuration in Infinity Studio):
