---
name: testcase-business-action-assert-status
description: Load when mapping a status assertion business action. Shows AssertCaseStatus with pyStatusValue and Status constant for terminal verification.
---
