---
name: "pxIsNotInListOfValuesInPageList"
description: "pxIsNotInListOfValuesInPageList: [the property list to look in] does not contain a page where [the property name to get value of] is in [comma delimited list of values to compare against]"
---
...
```json
{
  "purpose": "pxIsNotInListOfValuesInPageList",
  "pyFunctionData": {
    "pxObjClass": "Embed-UserFunction",
    "pyName": "pxIsNotInListOfValuesInPageList",
    "pyCity": "pxIsNotInListOfValuesInPageList",
    "pyBaseClass": "Rule-Obj-When",
    "pyClassName": "Work-",
    "pySmartPromptClass": "pyClassName",
    "pySignature": "@(Pega-RULES:String).pxIsNotInListOfValues({lookAt}, {listOfValues}, {lookIn})",
    ...
    "pyParameters": [
      ...
      },
      {
        ...
        "pyParametersParamDropdownValues": "Property",
        "pyIsOptional": "false",
        "pyParametersParamValue": "Cancelled,Rejected"
      },
      {
        "pxObjClass": "Embed-MethodParams",
  ...
  "pyCallParams": {
    "lookAt": ".Status",
    "listOfValues": "Cancelled,Rejected",
    "lookIn": ".Orders"
  }
}
```
